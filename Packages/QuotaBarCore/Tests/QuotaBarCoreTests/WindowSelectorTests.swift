...
struct WindowSelectorTests {
    @Test("a barra segue a janela limitante informada pela origem")
    ...
    @Test("a troca da janela limitante troca a seleção inteira")
    ...
    @Test("janela limitante ausente recai sobre o maior consumo, com procedência do app")
    ...
    @Test("janela limitante apontando para janela sem percentual usa a regra de contorno")
    ...
    @Test("a comparação usa o valor antes do truncamento")
    ...
    @Test("só a igualdade exata é empate, e o desempate é a janela de cinco horas")
    ...
    @Test("com uma única janela disponível, é ela a exibida")
    ...
    @Test("leitura sem nenhuma janela com percentual não é construível")
    ...
    @Test("valor de janela limitante não reconhecido é distinto de ausente")
    ...
    @Test("valor não reconhecido não descarta a leitura nem muda a janela escolhida")
    ...
    @Test("a janela informada só vale quando tem percentual disponível")
    ...
    @Test("a escolha do app nunca é gravada de volta no campo da origem")
