...
struct StalenessPolicyTests {
    @Test(
        "tabela de unidade do limite de obsolescência",
        arguments: [
    ...
    @Test("o piso de 10 minutos vale enquanto o dobro da cadência for menor")
    ...
    @Test("acima do piso o limite é o dobro da maior cadência de ociosidade")
    ...
    @Test("o teto de 40 minutos é salvaguarda e não é ultrapassado")
    ...
    @Test("a idade exatamente no limite ainda não é obsoleta")
    ...
    @Test("o limite depende da ociosidade, nunca do intervalo ampliado por falha")
