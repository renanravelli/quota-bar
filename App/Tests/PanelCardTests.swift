...
struct PanelCardTests {
    @Test(
        "o cartão acende os segmentos do medidor conforme o percentual",
        arguments: [
            (percent: "0", lit: 0),
            (percent: "0.1", lit: 1),
            (percent: "5", lit: 1),
    ...
    @Test("em 78,9% o cartão mostra 16 segmentos e o número 78%")
    ...
    @Test("o caso conhecido de 74,9% mantém medidor em 15 e número em 74%")
    ...
    @Test("o cartão é tingido pela cor contínua do gradiente")
    ...
    @Test("a cor do cartão não salta nas fronteiras de faixa da barra")
    ...
    @Test("abaixo de uma hora a contagem traz segundos")
    ...
    @Test("acima de uma hora a contagem omite segundos")
    ...
    @Test("o formato do texto acompanha a política, e não o contrário")
    ...
    @Test("reset ausente omite a contagem em vez de zerar")
    ...
    @Test("sem valor exibível o medidor fica apagado e não vira marcador de ausência")
    ...
    @Test("a barra de cadência representa o progresso até a próxima leitura")
    ...
    @Test("a barra é coerente com o que a linha de cadência declara em texto")
    ...
    @Test("o cartão não acrescenta informação além da exigida")
...
struct CountdownTickerTests {
    @Test("sem painel aberto o temporizador não corre")
    ...
    @Test("fechar o painel para o temporizador e ele não volta sozinho")
    ...
    @Test("abaixo de uma hora o temporizador escolhe 1 segundo")
    ...
    @Test("acima de uma hora o temporizador escolhe 60 segundos e não paga 1 Hz")
    ...
    @Test("sem instante de reset não há o que contar, e nada é iniciado")
    ...
    @Test("reiniciar substitui o temporizador da contagem regressiva em vez de acumular outro")
